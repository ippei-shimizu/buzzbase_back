module Api
  module V2
    class StatsController < Api::V2::ApplicationController
      ...
      # コース別はユーザーから見て同一カードの3タブ（コース別/球種別/投手別）= 1機能のため、
      # 3アクションで entitlement key を pitch_course_average の1つに共有する。
      ENTITLEMENT_BY_ACTION = {
        ...
        pitcher_faceoff_courses: 'pitch_course_average'
      }.freeze
      ...
      def pitcher_faceoff_courses
        render json: Stats::PitcherFaceoffCourseAggregator.new(**aggregator_params).call
      end
