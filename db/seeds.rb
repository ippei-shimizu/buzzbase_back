...
baseball_categories = [
  ...
  # 大学硬式
  { name: '北海道学生野球連盟（大学硬式）', hiragana: 'ほっかいどうがくせいやきゅうれんめい（だいがくこうしき）', katakana: 'ホッカイドウガクセイヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Hokkaido Gakusei Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '札幌学生野球連盟（大学硬式）', hiragana: 'さっぽろがくせいやきゅうれんめい（だいがくこうしき）', katakana: 'サッポログクセイヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Sapporo Gakusei Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '北東北大学野球連盟（大学硬式）', hiragana: 'きたとうほくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'キタトウホクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kita Tohoku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '仙台六大学野球連盟（大学硬式）', hiragana: 'せんだいろくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'センダイロクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Sendai Roku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '南東北大学野球連盟（大学硬式）', hiragana: 'みなみとうほくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'ミナミトウホクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Minami Tohoku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '千葉県大学野球連盟（大学硬式）', hiragana: 'ちばけんだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'チバケンダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Chiba Ken Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '関甲新学生野球連盟（大学硬式）', hiragana: 'かんこうしんがくせいやきゅうれんめい（だいがくこうしき）', katakana: 'カンコウシンガクセイヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kankou Shin Gakusei Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '東京新大学野球連盟（大学硬式）', hiragana: 'とうきょうしんだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'トウキョウシンダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Tokyo Shin Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '東京六大学野球連盟（大学硬式）', hiragana: 'とうきょうろくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'トウキョウロクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Tokyo Roku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '東都大学野球連盟（大学硬式）', hiragana: 'とうとだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'トウトダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Touto Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '首都大学野球連盟（大学硬式）', hiragana: 'しゅとだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'シュトダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Shuto Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '神奈川大学野球連盟（大学硬式）', hiragana: 'かながわだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'カナガワダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kanagawa Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '愛知大学野球連盟（大学硬式）', hiragana: 'あいちだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'アイチダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Aichi Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '東海地区大学野球連盟（大学硬式）', hiragana: 'とうかいちくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'トウカイチクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Tokai Chiku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '北陸大学野球連盟（大学硬式）', hiragana: 'ほくりくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'ホクリクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Hokuriku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '関西学生野球連盟（大学硬式）', hiragana: 'かんさいがくせいやきゅうれんめい（だいがくこうしき）', katakana: 'カンサイガクセイヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kansai Gakusei Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '関西六大学野球連盟（大学硬式）', hiragana: 'かんさいろくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'カンサイロクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kansai Roku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '阪神大学野球連盟（大学硬式）', hiragana: 'はんしんだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'ハンシンダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Hanshin Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '近畿学生野球連盟（大学硬式）', hiragana: 'きんきがくせいやきゅうれんめい（だいがくこうしき）', katakana: 'キンキガクセイヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kinki Gakusei Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '京滋大学野球連盟（大学硬式）', hiragana: 'けいじだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'ケイジダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Keiji Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '広島六大学野球連盟（大学硬式）', hiragana: 'ひろしまろくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'ヒロシマロクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Hiroshima Roku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '中国地区大学野球連盟（大学硬式）', hiragana: 'ちゅうごくちくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'チュウゴクチクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Chugoku Chiku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '四国地区大学野球連盟（大学硬式）', hiragana: 'しこくちくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'シコクチクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Shikoku Chiku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '九州六大学野球連盟（大学硬式）', hiragana: 'きゅうしゅうろくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'キュウシュウロクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kyushu Roku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '福岡六大学野球連盟（大学硬式）', hiragana: 'ふくおかろくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'フクオカロクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Fukuoka Roku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  { name: '九州地区大学野球連盟（大学硬式）', hiragana: 'きゅうしゅうちくだいがくやきゅうれんめい（だいがくこうしき）', katakana: 'キュウシュウチクダイガクヤキュウレンメイ（ダイガクコウシキ）', alphabet: 'Kyushu Chiku Daigaku Yakyuu Renmei (Daigaku Koushiki)' },
  # 大学軟式
  ...
  { name: '奥羽地区大学軟式野球連盟（大学軟式）', hiragana: 'おううちくだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'オウウチクダイガクナンシキヤキュウレンメイ', alphabet: 'Ouu Chiku Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  ...
  { name: '北関東大学軟式野球連盟（大学軟式）', hiragana: 'きたかんとうだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'キタカントウダイガクナンシキヤキュウレンメイ', alphabet: 'Kita Kanto Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  ...
  { name: '東都大学軟式野球連盟（大学軟式）', hiragana: 'とうとだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'トウトダイガクナンシキヤキュウレンメイ', alphabet: 'Touto Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  { name: '首都大学軟式野球連盟（大学軟式）', hiragana: 'しゅとだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'シュトダイガクナンシキヤキュウレンメイ', alphabet: 'Shuto Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  { name: '東関東大学軟式野球連盟（大学軟式）', hiragana: 'とうかんとうだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'トウカントウダイガクナンシキヤキュウレンメイ', alphabet: 'Tou Kanto Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  ...
  { name: '関東新大学軟式野球連盟（大学軟式）', hiragana: 'かんとうしんだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'カントウシンダイガクナンシキヤキュウレンメイ', alphabet: 'Kanto Shin Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  ...
  { name: '東海学生軟式野球連盟（大学軟式）', hiragana: 'とうかいがくせいなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'トウカイガクセイナンシキヤキュウレンメイ', alphabet: 'Tokai Gakusei Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  { name: '長野県大学軟式野球連盟（大学軟式）', hiragana: 'ながのけんだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'ナガノケンダイガクナンシキヤキュウレンメイ', alphabet: 'Nagano Ken Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  ...
  { name: '近畿学生軟式野球連盟（大学軟式）', hiragana: 'きんきがくせいなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'キンキガクセイナンシキヤキュウレンメイ', alphabet: 'Kinki Gakusei Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  { name: '関西六大学軟式野球連盟（大学軟式）', hiragana: 'かんさいろくだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'カンサイロクダイガクナンシキヤキュウレンメイ', alphabet: 'Kansai Roku Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  { name: '西都大学軟式野球連盟（大学軟式）', hiragana: 'せいとだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'セイトダイガクナンシキヤキュウレンメイ', alphabet: 'Seito Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  { name: '京滋大学軟式野球連盟（大学軟式）', hiragana: 'けいじだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'ケイジダイガクナンシキヤキュウレンメイ', alphabet: 'Keiji Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  ...
  { name: '沖縄県大学軟式野球連盟（大学軟式）', hiragana: 'おきなわけんだいがくなんしきやきゅうれんめい（だいがくなんしき）', katakana: 'オキナワケンダイガクナンシキヤキュウレンメイ', alphabet: 'Okinawa Ken Daigaku Nanshiki Yakyuu Renmei (Daigaku Nanshiki)' },
  # JABA
  ...
  # 独立リーグ
  { name: '四国アイランドリーグplus（独立リーグ）', hiragana: 'しこくあいらんどりーぐぷらす（どくりつリーぐ）', katakana: 'シコクアイランドリーグプラス（ドクリツリーグ）', alphabet: 'Shikoku Island League Plus (Dokuritsu League)' },
  ...
  { name: '北海道フロンティアリーグ（独立リーグ）', hiragana: 'ほっかいどうふろんてぃありーぐ（どくりつリーぐ）', katakana: 'ホッカイドウフロンティアリーグ（ドクリツリーグ）', alphabet: 'Hokkaido Frontier League (Dokuritsu League)' },
  { name: '日本海リーグ（独立リーグ）', hiragana: 'にほんかいりーぐ（どくりつリーぐ）', katakana: 'ニホンカイリーグ（ドクリツリーグ）', alphabet: 'Nihonkai League (Dokuritsu League)' },
  { name: 'さわかみ関西独立リーグ（独立リーグ）', hiragana: 'さわかみかんさいどくりつりーぐ（どくりつリーぐ）', katakana: 'サワカミカンサイドクリツリーグ（ドクリツリーグ）', alphabet: 'Sawakami Kansai Independent League (Dokuritsu League)' },
  { name: '北海道ベースボールリーグ（独立リーグ）', hiragana: 'ほっかいどうべーすぼーるりーぐ（どくりつリーぐ）', katakana: 'ホッカイドウベースボールリーグ（ドクリツリーグ）', alphabet: 'Hokkaido Baseball League (Dokuritsu League)' },
  { name: '日本海オセアンリーグ（独立リーグ）', hiragana: 'にほんかいおせあんりーぐ（どくりつリーぐ）', katakana: 'ニホンカイオセアンリーグ（ドクリツリーグ）', alphabet: 'Nihonkai Ocean League (Dokuritsu League)' },
  # 社会人軟式
