...
ActiveRecord::Schema[7.1].define(version: 20_260_517_100_004) do
  ...
  create_table 'user_subscription_events', force: :cascade do |t|
    ...
    t.index %w[user_id occurred_at], name: 'index_user_subscription_events_on_user_id_and_occurred_at'
  ...
  create_table 'webhook_events', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[provider external_event_id], name: 'index_webhook_events_on_provider_and_external_event_id', unique: true
